        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col s10 offset-s1">
                    <div class="center">
                        <h2><b>Cartografía</b></h2>
                    </div>  
                    <p class="flow-text" align="justify">La o el docente debe tirar el dado para seleccionar un área de la cartografía de los Premios Nacionales.</p>
